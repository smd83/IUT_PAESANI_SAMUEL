...
void __attribute__((interrupt, no_auto_psv)) _AD1Interrupt(void) {
    IFS0bits.AD1IF = 0;
    ADCResult[0] = ADC1BUF0; // Read the AN-scan input 1 conversion result droite
    ADCResult[1] = ADC1BUF1; // Read the AN3 conversion result milieu
    ADCResult[2] = ADC1BUF2;
    ADCResult[3] = ADC1BUF3;// Read the AN5 conversion result gauche0
